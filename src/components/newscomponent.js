...
const Newscomponent = (props) => {
  ...
  const updatestate = async () => {
    ...
    let apiUrl = `https://newsapi.org/v2/top-headlines?country=in&category=${props.genre}&apiKey=381e2704b183499ba83f6a3eb5043cca&page=${page}&pageSize=${props.noofitem}`;
    setloading(true);
